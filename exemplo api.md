...
## JDE 
``` dos
curl -X GET -i http://127.0.0.1:8080/cic/99988488068
curl -X GET -i http://127.0.0.1:8080/cic/62256092020
curl -X GET -i http://127.0.0.1:8080/cic/82951328000158
curl -X GET -i http://127.0.0.1:8080/cic/27704912020
```
